...
use PHPMVC\Models\SalesinvoicesdetailsModel;
...
class SalesinvoicesdetailsController extends AbstractController
{
    ...
    [
        'ProductName'     => 'req|alpha',
        'ProductId'      => 'alphanum',
        'Quantity'      => 'num|min(1)',
        'CreatedAt'      => 'req|vdate',
        'UnitName'     => 'alphanum',
        'PhoneNumber' => 'req|int|max(15)',
        'CEmail'        => 'req|email',
    ...
    public function defaultAction()
    {
        ...
        $this->language->load('salesinvoicesdetails.default');
        $this->_data['salesinvoicesdetails'] = SalesinvoicesdetailsModel::getAll();

//        $this->_data['salesinvoicesdetails'] = UserModel::getUsers($this->session->u);
...
//        require_once TCPDF_PATH . '/config/tcpdf_config.php';
    ...
    public function createAction()
    {
        ...
        $this->language->load('salesinvoicesdetails.create');
        $this->language->load('salesinvoicesdetails.labels');
        $this->language->load('salesinvoicesdetails.messages');
        $this->language->load('validation.errors');


        $this->_data['Assistantaccount'] = AccountassistantModel::getAll();

        $this->_data['PaymentType'] = PaymenttypeModel::getAll();
        $this->_data['Clint'] =ClientModel::getAll();
        $this->_data['ClintGroups'] = ClientgroupsModel::getAll();
        $this->_data['Assistantaccount'] =AccountassistantModel::getAll();
        $this->_data['StoreSub'] =SalesinvoicesModel::getAll();
        $this->_data['Productlist'] =ProductlistModel::getAll();
