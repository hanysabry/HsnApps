...
public $table = array(); // flag if we are in a sub html => only "text-align:left" is used
        /**
     * @var TagParser
     */
    protected $tagParser;  // default font to use if the asked font does not exist
    /**
     * @var CssConverter
     */
    protected $cssConverter; // current values
        /**
     * Reference to the pdf object
     *
     * @var MyPdf
     */
    protected $pdf = null; // css values
    protected $onlyLeft = false; // css key, for the execution order
    protected $defaultFont = null; // level history
