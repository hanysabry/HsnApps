<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n20 border padding">
            <label<?= $this->labelFloat('GeneralaccountName') ?>><?= $create_GeneralaccountName ?></label>
            <input required type="text" name="GeneralaccountName" value="<?= $this->showValue('GeneralaccountName') ?>">
        </div>

        <div class="input_wrapper n50 border">
            <label<?= $this->labelFloat('GeneralaccountNameEng') ?>><?= $create_GeneralaccountNameEng ?></label>
            <input   type="text" name="GeneralaccountNameEng"  value="<?= $this->showValue('GeneralaccountNameEng')?>">
        </div>



        <div class="input_wrapper_other n30 padding select">
            <select required name="MainaccountId" id="MainaccountId">
                <option><?=  $create_MainAccountId ?></option>
