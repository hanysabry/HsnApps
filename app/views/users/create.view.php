        ...
        <div class="input_wrapper_other padding n20 select">
            ...
            <div class="input_wrapper_other n20 padding select">
                <select required name="Status" id="Status">
                    ...
                    <option value="1"><?= $text_label_type_Active ?></option>
                    <option value="2"><?= $text_label_type_NotActive ?></option>
                </select>
            </div>
        ...
        <div class="input_wrapper_other padding n20 select">
            <select required name="CountryId">
                ...
                <?php endforeach;endif; ?>
                        ...
                        <div class="input_wrapper_other padding n20 select">
                            <select required name="CityId" id="CityId">
                                <option value=""><?= $text_CityId ?></option>
                                <?php if (false !== $city): foreach ($city as $citys): ?>
                                    <option value="<?= $citys->CityId ?>"><?= $citys->CityName ?></option>
                                <?php endforeach;endif; ?>
                    </select>
        </div>
